...
# Download a cell marker file and convert it to UNIX format (-Lu command) by nkf
for (sp in c('mouse', 'human')) {
    ...
    write.table(parsed_marker, file=paste0('cell_marker_', sp, 'blood.tsv'), sep="\t", quote=F)
}
